    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_ru', models.CharField(blank=True, max_length=200, null=True)),
                ('alt_uk', models.CharField(blank=True, max_length=200, null=True)),
                ('alt_en', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_uk', models.CharField(max_length=200, null=True, verbose_name='Название')),
                ('title_en', models.CharField(max_length=200, null=True, verbose_name='Название')),
                ('description', ckeditor_uploader.fields.RichTextUploadingField(blank=True, max_length=200, null=True, verbose_name='META Описание')),
                ('description_ru', ckeditor_uploader.fields.RichTextUploadingField(blank=True, max_length=200, null=True, verbose_name='META Описание')),
                ('description_uk', ckeditor_uploader.fields.RichTextUploadingField(blank=True, max_length=200, null=True, verbose_name='META Описание')),
                ('description_en', ckeditor_uploader.fields.RichTextUploadingField(blank=True, max_length=200, null=True, verbose_name='META Описание')),
